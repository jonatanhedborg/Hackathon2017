...
- @ref tobii - Core functions.
- @ref tobii_streams  - Basic gaze- and data streams.
- @ref tobii_wearable  - Gaze data streams for wearable/vr devices.
- @ref tobii_licensing  - Functionality related to licenses.
- @ref tobii_advanced  - Advanced gaze data streams for Tobii Pro customers.
- @ref tobii_config  - Calibration and display setup.
